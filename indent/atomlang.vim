...
" Description: The indent file for atomlang
...
setlocal indentexpr=AtomlangIndent()
...
function! s:IsExcludedFromIndentAtPosition(line, column)
  ...
  return name ==# "atomlangComment" || name ==# "atomlangString"
endfunction

function! s:IsExcludedFromIndent()
  return s:SyntaxName() ==# "atomlangComment" || s:SyntaxName() ==# "atomlangString"
endfunction
